 package com.example.rasesh.whatsappclone;
...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ChatRequestsRef = FirebaseDatabase.getInstance().getReference().child("Chats Requests");
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.exists()){
                                        ...
                                        if(type.equals("received")){
                                                ...
                                                public void onDataChange(DataSnapshot dataSnapshot) {
                                                    ...
                                                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View v) {
                                                            ...
                                                            builder.setTitle(requestUserName + " wants to connect with you");
                                            ...
                                            Button request_sent_btn = (Button)holder.itemView.findViewById(R.id.request_accept_btn);
